...
import { getLeagueColor, getLeagueUpgradeCost } from "@/utils/gameUtils"
import Image from "next/image"

export default function LeagueOverlay({ onClose, coins }: LeagueOverlayProps) {
  const [currentLeague, setCurrentLeague] = useState<number>(1)
  const totalLeagues = 10
  const sliderRef = useRef<HTMLDivElement>(null)

  const totalNeeded = getLeagueUpgradeCost(currentLeague + 1) || 0
  ...
  const leaderboardData = [
    { id: 1, name: "Player 1", coins: 15000, avatar: "/avatars/avatar1.png" },
    { id: 2, name: "Player 2", coins: 12000, avatar: "/avatars/avatar2.png" },
    { id: 3, name: "Player 3", coins: 10000, avatar: "/avatars/avatar3.png" },
    { id: 4, name: "Player 4", coins: 8000, avatar: "/avatars/avatar4.png" },
    { id: 5, name: "Player 5", coins: 6000, avatar: "/avatars/avatar5.png" },
  ]
      ...
      <div className="flex-grow flex flex-col items-center justify-center space-y-4">
        <div className="relative w-full max-w-xs">
          <div className="relative">
            ...
            ></div>
            <Image
              src={`/leagues/league-${currentLeague}.png`}
